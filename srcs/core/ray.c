...
t_ray			ray_to_obj(t_ray ray, t_obj *cyl)
{
	...
	new_ray.pos = vec_sub(new_ray.pos, cyl->pos);
	new_ray.pos = matrix_mult_vec(cyl->world_to_obj, new_ray.pos);
//	new_ray.dir = vec_add(ray.pos, ray.dir);
//	new_ray.dir = vec_sub(new_ray.dir, cyl->pos);
	new_ray.dir = matrix_mult_vec(cyl->world_to_obj, new_ray.dir);
