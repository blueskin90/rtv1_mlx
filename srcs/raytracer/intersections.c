...
/*   Updated: 2018/11/10 23:06:09 by cvermand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
float			sphere_intersection(t_sphere *sphere, t_ray ray)
{
	...
	length = vector_dotproduct(ray.dir, origin_to_sphere); // projette le centre de la sphere sur le vecteur de rayon et retourne la longueur
